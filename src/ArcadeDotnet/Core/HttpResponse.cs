...
public class HttpResponse : IDisposable
{
    ...
    {
        if (obj is not global::ArcadeDotnet.Core.HttpResponse other)
        {
            return false;
        }
...
public sealed class HttpResponse<T> : global::ArcadeDotnet.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::ArcadeDotnet.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::ArcadeDotnet.Core.HttpResponse
{

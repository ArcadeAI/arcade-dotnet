...
using ArcadeDotnet.Models.Chat.Completions.CompletionCreateParamsProperties.ResponseFormatProperties;

namespace ArcadeDotnet.Models.Chat.Completions.CompletionCreateParamsProperties;

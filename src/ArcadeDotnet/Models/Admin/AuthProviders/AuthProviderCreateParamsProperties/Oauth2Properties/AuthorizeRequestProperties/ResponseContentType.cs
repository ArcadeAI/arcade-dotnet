...
namespace ArcadeDotnet.Models.Admin.AuthProviders.AuthProviderCreateParamsProperties.Oauth2Properties.AuthorizeRequestProperties;
...
internal sealed class ResponseContentTypeConverter : JsonConverter<ResponseContentType>
{

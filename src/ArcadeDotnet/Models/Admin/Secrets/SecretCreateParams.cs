...
/// </summary>
public record class SecretCreateParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public override string ToString() =>
        JsonSerializer.Serialize(
            FriendlyJsonPrinter.PrintValue(
                ...
                {
                    ["SecretKey"] = JsonSerializer.SerializeToElement(this.SecretKey),
    ...
    public virtual bool Equals(SecretCreateParams? other)
    {
        if (other == null)
        {
            return false;
        }
        return (this.SecretKey?.Equals(other.SecretKey) ?? other.SecretKey == null)

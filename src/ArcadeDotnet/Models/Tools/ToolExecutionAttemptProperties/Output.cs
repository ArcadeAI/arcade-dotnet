...
using OutputProperties = ArcadeDotnet.Models.Tools.ToolExecutionAttemptProperties.OutputProperties;

namespace ArcadeDotnet.Models.Tools.ToolExecutionAttemptProperties;

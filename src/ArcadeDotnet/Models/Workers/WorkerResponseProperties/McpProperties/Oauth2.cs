...
using ArcadeDotnet.Models.Workers.WorkerResponseProperties.McpProperties.Oauth2Properties;

namespace ArcadeDotnet.Models.Workers.WorkerResponseProperties.McpProperties;

...
using ArcadeDotnet.Models.Workers.WorkerResponseProperties.RequirementsProperties.AuthorizationProperties;

namespace ArcadeDotnet.Models.Workers.WorkerResponseProperties.RequirementsProperties;

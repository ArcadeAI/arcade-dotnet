...
public class WorkerUpdateParamsTest : TestBase
{
    ...
    {
        WorkerUpdateParams parameters = new() { ID = "id" };
...
public class WorkerUpdateParamsHttpTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<WorkerUpdateParamsHttp>(
            json,
...
public class WorkerUpdateParamsMcpTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WorkerUpdateParamsMcp>(
            json,
            ModelBase.SerializerOptions
        );
...
public class WorkerUpdateParamsMcpOauth2Test : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WorkerUpdateParamsMcpOauth2>(
            json,
            ModelBase.SerializerOptions
        );

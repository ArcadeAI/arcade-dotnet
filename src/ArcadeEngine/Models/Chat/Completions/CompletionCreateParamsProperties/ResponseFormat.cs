...
using ArcadeEngine.Models.Chat.Completions.CompletionCreateParamsProperties.ResponseFormatProperties;

namespace ArcadeEngine.Models.Chat.Completions.CompletionCreateParamsProperties;

...
using OutputProperties = ArcadeEngine.Models.Tools.ExecuteToolResponseProperties.OutputProperties;

namespace ArcadeEngine.Models.Tools.ExecuteToolResponseProperties;

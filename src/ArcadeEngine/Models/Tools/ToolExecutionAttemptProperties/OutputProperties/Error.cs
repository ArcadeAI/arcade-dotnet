...
using ArcadeEngine.Models.Tools.ToolExecutionAttemptProperties.OutputProperties.ErrorProperties;

namespace ArcadeEngine.Models.Tools.ToolExecutionAttemptProperties.OutputProperties;

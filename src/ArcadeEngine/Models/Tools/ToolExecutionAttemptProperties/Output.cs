...
using OutputProperties = ArcadeEngine.Models.Tools.ToolExecutionAttemptProperties.OutputProperties;

namespace ArcadeEngine.Models.Tools.ToolExecutionAttemptProperties;

...
using ArcadeEngine.Models.Admin.AuthProviders.AuthProviderCreateParamsProperties.Oauth2Properties.AuthorizeRequestProperties;

namespace ArcadeEngine.Models.Admin.AuthProviders.AuthProviderCreateParamsProperties.Oauth2Properties;
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    AuthorizeRequest(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static AuthorizeRequest FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {

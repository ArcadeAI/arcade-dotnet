...
var page = await client.Admin.UserConnections.List(parameters);
...
var page = await client.Admin.UserConnections.List();
while (true)
{
...
var parameters = ToolExecuteParams.FromRawUnchecked
(
...
CompletionCreateParams parameters = new()
{
    ResponseFormat = ResponseFormat.FromRawUnchecked
    (
        new Dictionary<string, JsonElement>
        {
...
var response = client.Tools.Execute(parameters)
